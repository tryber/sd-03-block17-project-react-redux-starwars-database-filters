...
import { filterByNumericValues } from '../../actions/apiAction';
...
export class FilterByValue extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(FilterByValue);
